...
describe("roleService", () => {
    describe("getUserInfoByUserId",  () => {
        it('should return response', async () => {
            jest.spyOn(db, 'runQuery').mockResolvedValueOnce([{ user_id: 1, netid: 'twmiller', first_name: 'Phil', last_name: 'Swift', password: 'hee hee'}]);
            const res = await getUserInfoByUserId(1);
            expect(res).toEqual([{ user_id: 1, netid: 'twmiller', first_name: 'Phil', last_name: 'Swift', password: 'hee hee'}])
        })
